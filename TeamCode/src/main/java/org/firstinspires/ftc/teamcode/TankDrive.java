...
public final class TankDrive {
    public static class Params {
        ...
        public double inPerTick = 19.685 / 915;
        public double trackWidthTicks = 623.0638599138224;

        // feedforward parameters (in tick units)
        public double kS = 1.8264582763979007;
        public double kV = 0.004075967415637917;
